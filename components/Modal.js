						...
						>
                          <div>
                            ...
                            <div
                                ...
                                rounded-full bg-red-10 cursor-pointer"
                              >
                                  <CameraIcon
						...
						<div className="mt-5 sm:mt-6">
                              <button
								...
								className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm
                                    ...
                                    focus:ring-2 focus:ring-offset-2 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300"
							>
